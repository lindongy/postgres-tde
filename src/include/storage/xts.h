...
extern INT_RETURN xts_encrypt_block( unsigned char sector[], const unsigned char tweak[],
									 unsigned int sector_len, xts_encrypt_ctx ctx[1] );

extern INT_RETURN xts_decrypt_block( unsigned char sector[], const unsigned char tweak[],
